...
var ReconnectingWebSocket = /** @class */ (function () {
  function ReconnectingWebSocket(url, protocols, options) {
    ...
    this._handleError = function (event) {
      ...
      // This if clause {} Wrap is very important - added by us Ahmed Eltahwihi
      if (_this._ws.readyState === this.OPEN) {
  ...
  ReconnectingWebSocket.prototype._disconnect = function (code, reason) {
    console.log("im here trying to");
    // This if clause {} Wrap is very important - added by us Ahmed Eltahwihi
    // trying to disconnect only if a connection is established { OPEN }
    if (this._ws.readyState === this.OPEN) {
      if (code === void 0) {
        code = 1000;
      }
